...
function validateWires() {
  ...
  comps.forEach(c => {
    if(BOARDS.includes(c.type)) return; // boards don't need external VCC
    const def = DEFS[c.type]; if(!def) return;
